...
public class X {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("주사위를 굴리려면 d를 제외한 아무키나 입력하세요 ");
			...
			if(op==1) {System.out.println(t.getone(one)); 
			bw.write("ⅰ        -                "+String.valueOf(t.getone(one)+"점\n"));
			bw.flush();
				...
				bw.write("ⅱ        -                "+String.valueOf(t.gettwo(two)+ "점 \n"));
				bw.flush();
				}
				...
				bw.write("ⅲ        -                "+String.valueOf(t.getthree(three)+ "점 \n"));
				bw.flush();
				}
				...
				bw.write("ⅳ        -                "+String.valueOf(t.getfour(four)+ "점 \n"));
				bw.flush();
				}
				...
				bw.append("ⅴ        -                "+String.valueOf(t.getfive(five) + "점 \n"));
				bw.flush();
				}
				...
				bw.write("ⅵ        -                "+String.valueOf(t.getsix(six) + "점 \n"));
				bw.flush();
				}
				...
				bw.write("√        -                "+String.valueOf(t.getchance(one,two,three,four,five,six)+ "점 \n"));
				bw.flush();
			}
				...
				bw.write("ㆍ        -                "+String.valueOf(t.getfd(one, two, three, four, five, six)+ "점 \n"));
				bw.flush();
			}
				...
				bw.write("￠        -                "+String.valueOf(t.getfh(one, two, three, four, five, six)+ "점 \n"));
				bw.flush();
			}
				...
				bw.write("⒮        -                "+String.valueOf(t.getst(one, two, three, four, five, six)+ "점 \n"));
				bw.flush();
			}
				...
				bw.write("Ω        -                "+String.valueOf(t.getls(one, two, three, four, five, six)+ "점 \n"));
				bw.flush();
			}
				...
				bw.write("ψyachtψ     -                "+String.valueOf(t.getyacht(one, two, three, four, five, six)+ "점 \n"));
				bw.flush();
			}
