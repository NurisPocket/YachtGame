	...
	public static void main(String[] args) {
		...
		while (true) {

			{
				...
				switch (op) {
				case 1:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("원"))
							{
						hSet11.put("원", t.getone(one));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("원")) {
				...
				case 2:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("투")) {
						hSet11.put("투", t.gettwo(two));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("투")) {
				...
				case 3:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("쓰리")) {
						hSet11.put("쓰리", t.getthree(three));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("쓰리")) {
				...
				case 4:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("포")) {
						hSet11.put("포", t.getfour(four));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("포")) {
				...
				case 5:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("파이브")) {
						hSet11.put("파이브", t.getfive(five));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("파이브")) {
				...
				case 6:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("식스")) {
						hSet11.put("식스", t.getsix(six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("식스")) {
				...
				case 7:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("찬스")) {
						hSet11.put("찬스", t.getchance(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("찬스")) {
				...
				case 8:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("포다이스")) {
						hSet11.put("포다이스", t.getfd(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("포다이스")) {
				...
				case 9:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("풀하우스")) {
						hSet11.put("풀하우스", t.getfh(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("풀하우스")) {
				...
				case 10:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("스트레이트")) {
						hSet11.put("스트레이트", t.getst(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("스트레이트")) {
				...
				case 11:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0)
							&& true == hSet11.containsKey("로얄 스트레이트")) {
						hSet11.put("로얄 스트레이트", t.getls(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("로얄 스트레이트")) {
				...
				case 12:
					if (playerTurn % 2 == 1 && true == hSet11.containsValue(0) && true == hSet11.containsKey("야추")) {
						hSet11.put("야추", t.getyacht(one, two, three, four, five, six));
						break;
					} else if (playerTurn % 2 == 0 && true == hSet22.containsValue(0)
							&& true == hSet22.containsKey("야추")) {
