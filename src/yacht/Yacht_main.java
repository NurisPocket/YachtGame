	...
	public static void main(String[] args) {
		...
		System.out.println("주사위를 굴리려면 d를 제외한 아무키나 입력하세요 ");
			...
			if(op==1) {
				...
				if (playerTurn%2==1) {hSet11.put("원", t.getone(one));}
				else {hSet22.put("원", t.getone(one));} 
			}
			
			else if(op==2) {
				System.out.println(t.gettwo(two)); 			
				if (playerTurn%2==1) {hSet11.put("투", t.gettwo(two));}
				else {hSet22.put("투", t.gettwo(two));}
			}
				
			else if(op==3) {
				System.out.println(t.getthree(three)); 
				if (playerTurn%2==1) {hSet11.put("쓰리", t.getthree(three));}
				else {hSet22.put("쓰리", t.getthree(three));}
				}
			
			else if(op==4) {
				System.out.println(t.getfour(four)); 
				if (playerTurn%2==1) {hSet11.put("포", t.getfour(four));}
				else {hSet22.put("포", t.getfour(four));}
				}
			
			else if(op==5) {
				System.out.println(t.getfive(five));
				if (playerTurn%2==1) {hSet11.put("파이브", t.getfive(five));}
				else {hSet22.put("파이브", t.getfive(five));}
				}
			else if(op==6) {
				System.out.println(t.getsix(six)); 
				if (playerTurn%2==1) {hSet11.put("식스", t.getsix(six));}
				else {hSet22.put("식스", t.getsix(six));}
				}
			else if(op==7) {
				System.out.println(t.getchance(one,two,three,four,five,six));
				if (playerTurn%2==1) {hSet11.put("찬스", t.getchance(one,two,three,four,five,six));}
				else {hSet22.put("찬스", t.getchance(one,two,three,four,five,six));}
				}
			else if(op==8) {				
				System.out.println(t.getfd(one, two, three, four, five, six));
				if (playerTurn%2==1) {hSet11.put("포다이스", t.getfd(one, two, three, four, five, six));}
				else {hSet22.put("포다이스", t.getfd(one, two, three, four, five, six));}
				}
			else if(op==9) {
				System.out.println(t.getfh(one, two, three, four, five, six));
				if (playerTurn%2==1) {hSet11.put("풀하우스", t.getfh(one, two, three, four, five, six));}
				else {hSet22.put("풀하우스", t.getfh(one, two, three, four, five, six));}
				}
			else if(op==10) {
				System.out.println(t.getst(one, two, three, four, five, six));
				if (playerTurn%2==1) {hSet11.put("스트레이트", t.getst(one, two, three, four, five, six));}
				else {hSet22.put("스트레이트", t.getst(one, two, three, four, five, six));}
				}
			else if(op==11) {
				System.out.println(t.getls(one, two, three, four, five, six));
				if (playerTurn%2==1) {hSet11.put("로얄 스트레이트", t.getls(one, two, three, four, five, six));}
				else {hSet22.put("로얄 스트레이트", t.getls(one, two, three, four, five, six));}
				}
			else if(op==12) {
				System.out.println(t.getyacht(one, two, three, four, five, six));
				if (playerTurn%2==1) {hSet11.put("야추", t.getyacht(one, two, three, four, five, six));}
				else {hSet22.put("야추", t.getyacht(one, two, three, four, five, six));}
				}			
